...
#property strict
// Acane M1: AcaneM1_v1_quality_mrv_4264: generated Acane tuning test.
...
const double ACANE_MaxSameSideOpenRiskPct = 5.00;
const double ACANE_BasketLossStopPct = 5.00;
...
const double ACANE_MrvMaxImpulseATR = 0.70;
const double ACANE_MrvMaxEmaDistanceATR = 0.90;
...
const double ACANE_MeanReversionTouchATR = 0.08;
...
int OnInit()
  {
   ...
   AcaneResetWeeklyGuardIfNeeded();
   AcaneResetMonthlyGuardIfNeeded();
   PrintFormat("AcaneM1_v1_quality_mrv_4264 PROFILE | symbol=%s tf=M1 risk=%.2f maxPos=%d sameSide=%d dailyLoss=%.2f accountCircuit=%.2f openRisk=%.2f basketStop=%.2f spreadMax=%.2f statusEvery=%d debugEvery=%d",
               _Symbol,
               ACANE_RiskPercent,
               ACANE_MaxPositions,
