...
#property strict
// Acane v2 research variant AcaneM1_v2_stack3_4264.
...
const int    ACANE_MaxPositions = 6;
const int    ACANE_MaxSameSidePositions = 3;
const int    ACANE_MinSecondsBetweenEntries = 45;
...
int OnInit()
  {
   ...
   AcaneResetWeeklyGuardIfNeeded();
   AcaneResetMonthlyGuardIfNeeded();
   PrintFormat("ACANE V2 RESEARCH AcaneM1_v2_stack3_4264 | symbol=%s tf=M1 risk=%.2f maxPos=%d sameSide=%d dailyLoss=%.2f accountCircuit=%.2f openRisk=%.2f basketStop=%.2f spreadMax=%.2f statusEvery=%d debugEvery=%d",
               _Symbol,
               ACANE_RiskPercent,
               ACANE_MaxPositions,
