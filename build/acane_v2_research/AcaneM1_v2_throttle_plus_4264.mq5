...
#property strict
// Acane v2 research variant AcaneM1_v2_throttle_plus_4264.
...
const int    ACANE_MinSecondsBetweenEntries = 120;
...
const string ACANE_BlockEntryHours = "0,2,5,11,20";
...
const double ACANE_MinLotFallbackMaxRiskPct = 6.00;
...
int OnInit()
  {
   ...
   AcaneResetWeeklyGuardIfNeeded();
   AcaneResetMonthlyGuardIfNeeded();
   PrintFormat("ACANE V2 RESEARCH AcaneM1_v2_throttle_plus_4264 | symbol=%s tf=M1 risk=%.2f maxPos=%d sameSide=%d dailyLoss=%.2f accountCircuit=%.2f openRisk=%.2f basketStop=%.2f spreadMax=%.2f statusEvery=%d debugEvery=%d",
               _Symbol,
               ACANE_RiskPercent,
               ACANE_MaxPositions,
