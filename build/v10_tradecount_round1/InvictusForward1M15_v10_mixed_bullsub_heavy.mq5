...
input double V10_WeakBuyRiskMultiplier = 0.24;
...
input int    V10_BuySessionStartHour = 3;
...
input int    V10_BullSubCompressionBars = 5;
input double V10_BullSubMaxRangeATR = 1.90;
input double V10_BullSubTouchEmaATR = 0.18;
input double V10_BullSubBreakATR = 0.04;
input double V10_BullSubMinBodyRatio = 0.58;
input double V10_BullSubRiskMultiplier = 0.35;
input double V10_BullSubRR = 1.70;
