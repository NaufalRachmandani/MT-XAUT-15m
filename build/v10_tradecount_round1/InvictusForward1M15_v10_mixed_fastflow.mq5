...
input double V10_RiskPercent = 5.25;
...
input double V10_BullSubRiskMultiplier = 0.22;
...
input int    V10_ChopLookbackBars = 8;
input int    V10_MaxEmaFlips = 4;
input int    V10_HoldBars = 1;
