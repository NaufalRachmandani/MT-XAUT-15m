...
input double V10_RiskPercent = 6.00;
input double V10_BuyRiskMultiplier = 0.60;
input double V10_SellRiskMultiplier = 1.10;
input double V10_WeakBuyRiskMultiplier = 0.25;
input double V10_WeakSellRiskMultiplier = 0.75;
input bool   V10_EnableBuys = true;
input bool   V10_EnableSells = true;
input int    V10_MaxPositions = 5;
input int    V10_WeakRegimeMaxPositions = 3;
input int    V10_SellSessionStartHour = 4;
input int    V10_SellSessionEndHour = 23;
input int    V10_BuySessionStartHour = 2;
input int    V10_BuySessionEndHour = 23;
input bool   V10_StrongBullRelaxBuySession = false;
input bool   V10_EnableMixedMomentumEntries = true;
...
input bool   V10_UseBuyCoreHours = false;
input bool   V10_EnableBullSubEngine = true;
input bool   V10_BullSubAllowWeakBull = true;
input int    V10_BullSubSessionStartHour = 0;
input int    V10_BullSubSessionEndHour = 23;
input bool   V10_BullSubOnlyOutsideCore = false;
...
input double V10_BullSubRiskMultiplier = 0.25;
...
input double V10_MinBreakATR = 0.04;
