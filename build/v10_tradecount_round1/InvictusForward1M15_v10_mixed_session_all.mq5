...
input double V10_RiskPercent = 5.75;
input double V10_BuyRiskMultiplier = 0.60;
input double V10_SellRiskMultiplier = 1.15;
input double V10_WeakBuyRiskMultiplier = 0.25;
input double V10_WeakSellRiskMultiplier = 0.80;
...
input int    V10_BuySessionStartHour = 0;
...
input double V10_BullSubRiskMultiplier = 0.26;
...
input double V10_BuyMinBreakATR = 0.06;
input double V10_WeakSellMinBreakATR = 0.08;
input double V10_WeakBuyMinBreakATR = 0.10;
input double V10_MinBodyRatio = 0.48;
input double V10_BuyMinBodyRatio = 0.48;
input double V10_WeakSellMinBodyRatio = 0.54;
input double V10_WeakBuyMinBodyRatio = 0.54;
