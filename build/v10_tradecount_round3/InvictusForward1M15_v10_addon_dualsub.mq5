...
input int    V10_BullSubSessionStartHour = 5;
input int    V10_BullSubSessionEndHour = 20;
...
input double V10_BullSubRiskMultiplier = 0.12;
input double V10_BullSubRR = 1.50;
input int    V10_BullSubMaxHoldBars = 24;
input bool   V10_EnableBearSubEngine = true;
input bool   V10_BearSubAllowWeakBear = true;
input int    V10_BearSubSessionStartHour = 8;
input int    V10_BearSubSessionEndHour = 20;
...
input double V10_BearSubRiskMultiplier = 0.16;
input double V10_BearSubRR = 1.50;
...
input bool   V10_AddOnAllowWeakRegime = true;
...
input double V10_AddOnRiskMultiplier = 0.45;
input double V10_AddOnRR = 1.15;
input int    V10_AddOnMaxHoldBars = 14;
