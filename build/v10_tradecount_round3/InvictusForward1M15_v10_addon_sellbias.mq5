...
input int    V10_SellSessionStartHour = 7;
input int    V10_SellSessionEndHour = 21;
...
input double V10_BearSubRiskMultiplier = 0.20;
input double V10_BearSubRR = 1.55;
...
input double V10_AddOnMinProgressR = 0.55;
input double V10_AddOnBreakATR = 0.01;
input double V10_AddOnMinBodyRatio = 0.52;
input double V10_AddOnRiskMultiplier = 0.50;
input double V10_AddOnRR = 1.20;
input int    V10_AddOnMaxHoldBars = 16;
