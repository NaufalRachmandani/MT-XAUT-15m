...
input int    V10_ZoneLookback = 11;
input double V10_ZoneMinBodyRatio = 0.54;
input double V10_ZoneBreakATR = 0.04;
input double V10_ZoneMidTouchATR = 0.06;
input double V10_ZoneReclaimATR = 0.00;
input double V10_ZoneOvershootATR = 0.20;
input double V10_ZoneRiskMultiplier = 0.60;
input double V10_ZoneRR = 1.40;
...
input double V10_WeakBuyMinBreakATR = 0.14;
input double V10_MinBodyRatio = 0.44;
...
input double V10_AddOnMinProgressR = 0.80;
input double V10_AddOnBreakATR = 0.02;
input double V10_AddOnMinBodyRatio = 0.58;
input double V10_AddOnRiskMultiplier = 0.35;
