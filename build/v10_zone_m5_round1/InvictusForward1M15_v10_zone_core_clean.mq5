...
input bool   V10_ZoneAllowWeakRegime = false;
input bool   V10_ZoneUseCoreHours = true;
input int    V10_ZoneLookback = 14;
input double V10_ZoneMinBodyRatio = 0.58;
input double V10_ZoneBreakATR = 0.06;
input double V10_ZoneMidTouchATR = 0.05;
input double V10_ZoneReclaimATR = 0.00;
input double V10_ZoneOvershootATR = 0.18;
input double V10_ZoneRiskMultiplier = 0.50;
input double V10_ZoneRR = 1.55;
input int    V10_ZoneMaxHoldBars = 20;
