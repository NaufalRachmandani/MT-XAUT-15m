...
input double V6_TrendRiskPercent = 0.75;
input double V6_SidewaysRiskPercent = 0.35;
...
input double V6_HighScoreBuyRiskMultiplier = 1.10;
input int    V6_TrendMaxPositions = 7;
input int    V6_SidewaysMaxPositions = 8;
input double V6_TrendDailyLossCapPercent = 5.0;
input double V6_SidewaysDailyLossCapPercent = 3.0;
