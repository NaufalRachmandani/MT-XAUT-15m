...
input double V6_TrendRiskPercent = 2.75;
input double V6_SidewaysRiskPercent = 1.20;
input double V6_SellRiskMultiplier = 0.95;
...
input double V6_HighScoreBuyRiskMultiplier = 1.20;
input int    V6_TrendMaxPositions = 9;
input int    V6_SidewaysMaxPositions = 10;
input double V6_TrendDailyLossCapPercent = 8.0;
input double V6_SidewaysDailyLossCapPercent = 5.0;
