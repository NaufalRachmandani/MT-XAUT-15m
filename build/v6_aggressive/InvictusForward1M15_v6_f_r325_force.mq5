...
input double V6_TrendRiskPercent = 3.25;
input double V6_SidewaysRiskPercent = 1.40;
input double V6_SellRiskMultiplier = 1.00;
...
input double V6_HighScoreBuyRiskMultiplier = 1.25;
input int    V6_TrendMaxPositions = 10;
input int    V6_SidewaysMaxPositions = 10;
input double V6_TrendDailyLossCapPercent = 9.0;
input double V6_SidewaysDailyLossCapPercent = 6.0;
input bool   V6_SkipTradeBelowMinLot = false;
