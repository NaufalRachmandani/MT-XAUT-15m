...
input double RangeBounce_LotMult     = 0.25;   // Lot = X * trending lot (conservative)
input int    RangeBounce_MaxBuy      = 2;      // Max simultaneous BUY bounce
...
input int    RangeBounce_MaxEntriesPerRange = 4; // Max range entries per detected range/day
...
input int    Guard_MaxTrendPosLowBalance  = 3; // <= 20k balance
...
input double DropCatcher_LotMult     = 0.25;   // Lot = X * normal trending lot
