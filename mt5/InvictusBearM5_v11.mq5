...
input double V10_RiskPercent = 5.00;
input double V10_BuyRiskMultiplier = 0.60;
input double V10_SellRiskMultiplier = 1.00;
input double V10_WeakBuyRiskMultiplier = 0.22;
input double V10_WeakSellRiskMultiplier = 0.55;
input bool   V10_EnableBuys = false;
input bool   V10_EnableSells = true;
input int    V10_MaxPositions = 8;
input int    V10_WeakRegimeMaxPositions = 3;
input int    V10_SellSessionStartHour = 0;
input int    V10_SellSessionEndHour = 23;
...
input long   V11_OppositeMagic = 2026042411;
...
input bool   V10_EnableBearSubEngine = true;
input bool   V10_BearSubAllowWeakBear = true;
...
input double V10_BearSubMinBodyRatio = 0.46;
input double V10_BearSubRiskMultiplier = 0.28;
input double V10_BearSubRR = 1.20;
...
input int    V10_ZoneLookback = 10;
input double V10_ZoneMinBodyRatio = 0.40;
input double V10_ZoneBreakATR = 0.00;
input double V10_ZoneMidTouchATR = 0.18;
input double V10_ZoneReclaimATR = 0.00;
input double V10_ZoneOvershootATR = 0.55;
input double V10_ZoneRiskMultiplier = 0.70;
input double V10_ZoneRR = 1.05;
...
input double V10_BuyMinBreakATR = 0.08;
input double V10_WeakSellMinBreakATR = 0.08;
input double V10_WeakBuyMinBreakATR = 0.12;
input double V10_MinBodyRatio = 0.46;
input double V10_BuyMinBodyRatio = 0.50;
input double V10_WeakSellMinBodyRatio = 0.50;
input double V10_WeakBuyMinBodyRatio = 0.56;
...
input int    V10_MinTradeScore = 60;
...
input bool   V10_EnableAddOnEngine = true;
input bool   V10_EnableBuyAddOns = false;
input bool   V10_EnableSellAddOns = true;
input bool   V10_AddOnAllowWeakRegime = false;
input int    V10_AddOnMaxPerSide = 2;
input double V10_AddOnMinProgressR = 0.35;
input double V10_AddOnBreakATR = 0.02;
input double V10_AddOnMinBodyRatio = 0.46;
input double V10_AddOnRiskMultiplier = 0.32;
input double V10_AddOnRR = 0.95;
...
input bool   V11_SellImpulseTimeCloseProfitOnly = true;
...
static const ulong V10_MAGIC = 2026042412;
...
string V10BuildComment(const string engineCode, const int score, const string grade, const string tags)
  {
   string comment = "S11|" + V11EngineComment(engineCode) + "|" + engineCode + "|S" + IntegerToString(score) + "|" + grade;
   if(tags != "")
      comment += "|" + tags;
