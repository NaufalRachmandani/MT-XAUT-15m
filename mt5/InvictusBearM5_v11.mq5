...
input int    V10_MaxPositions = 6;
input int    V10_WeakRegimeMaxPositions = 2;
...
input int    V10_ZoneLookback = 8;
input double V10_ZoneMinBodyRatio = 0.46;
input double V10_ZoneBreakATR = 0.02;
input double V10_ZoneMidTouchATR = 0.10;
...
input double V10_AddOnMinProgressR = 0.65;
...
string V10BuildComment(const string engineCode, const int score, const string grade, const string tags)
  {
   string comment = "S11|" + engineCode + "|S" + IntegerToString(score) + "|" + grade;
   if(tags != "")
      comment += "|" + tags;
