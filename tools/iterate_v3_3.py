...
PARAMS: dict[str, Any] = {
    ...
    "IF1_TREND_LOW_SCORE_SELL_LOT_MULT": 1.0,
...
ITERATIONS: list[dict[str, Any]] = [
    {
        "name": "baseline",
        "hypothesis": "Baseline v3.2 final dengan telemetry sell sebagai pembanding awal v3.3.",
        "changes": {},
    },
    {
        "name": "low_sell_rr_135",
        "hypothesis": "Low-score sell terlalu sering kena SL, jadi TP-nya dipendekkan agar lebih cepat cashout.",
        "changes": {
            "IF1_TREND_LOW_SCORE_SELL_RR_OVERRIDE": 1.35,
        },
    },
    {
        "name": "low_sell_rr_125",
        "hypothesis": "Versi lebih agresif dari TP sell pendek untuk bucket score rendah.",
        "changes": {
            "IF1_TREND_LOW_SCORE_SELL_RR_OVERRIDE": 1.25,
        },
    },
    {
        "name": "low_sell_rr_135_lot_060",
        "hypothesis": "Kurangi lot khusus low-score sell sambil memendekkan TP mereka.",
        "changes": {
            "IF1_TREND_LOW_SCORE_SELL_RR_OVERRIDE": 1.35,
    ...
    {
        "name": "sell_score_80",
        "hypothesis": "Buang hanya sell score 75, tapi pertahankan sell 80+ agar hedge tidak hilang total.",
        "changes": {
            "IF1_SCORE_SELL_MIN_OVERRIDE": 80,
        },
    },
    {
        "name": "sell_score_80_low_rr_135",
        "hypothesis": "Gabungkan cut-off score 80 dengan TP lebih pendek untuk sell score rendah yang tersisa.",
        "changes": {
            "IF1_SCORE_SELL_MIN_OVERRIDE": 80,
            "IF1_TREND_LOW_SCORE_SELL_RR_OVERRIDE": 1.35,
        },
...
def write_summary(results: list[IterationResult], champion: IterationResult) -> None:
    json_path = RUN_DIR / "v3_3_sell_results.json"
    md_path = RUN_DIR / "v3_3_sell_summary.md"
