...
PRESETS = [
    Preset("control", "Current v7 seed after structural override patch.", {}),
    Preset("champion11_r120", "Round1 winner logic on updated seed.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
    }),
    Preset("champion11_market", "Round1 winner plus market-only trend execution.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_TREND_MARKET_ONLY": "true",
    }),
    Preset("champion11_allsell", "Round1 winner plus all sell hours.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_ALLOW_ALL_SELL_HOURS": "true",
    }),
    Preset("champion11_pending", "Round1 winner plus pending manager.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_ENABLE_PENDING_MANAGER": "true",
    }),
    Preset("champion11_breakeven", "Round1 winner plus breakeven manager.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_ENABLE_BREAKEVEN_MANAGER": "true",
    }),
    Preset("champion11_manage_both", "Round1 winner plus pending and breakeven managers.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_ENABLE_PENDING_MANAGER": "true",
    ...
    Preset("champion11_r150", "Round1 winner with harder risk.", {
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
    }),
    Preset("champion11_r150_market", "Harder risk plus market-only.", {
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "V7_TREND_MARKET_ONLY": "true",
    }),
    Preset("champion11_buy70", "Round1 winner with looser buy score.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "IF1_SCORE_BUY_MIN_OVERRIDE": "70",
    }),
    Preset("champion11_no_impulsive_buy", "Round1 winner without high-score impulsive buy requirement.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
        "IF1_GOLD_HIGH_SCORE_BUY_REQUIRE_IMPULSIVE_BOS": "false",
    }),
    Preset("champion11_sideways35", "Round1 winner with more permissive sideways ADX.", {
        "V7_TrendRiskPercent": "1.20",
        "V7_SidewaysRiskPercent": "0.40",
        "IF1TrendToxicHoursOverride": "{3, 7, 8, 9, 10, 17}",
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v7", source_path, f"round2_{preset.name}")
