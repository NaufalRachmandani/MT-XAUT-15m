...
PRESETS = [
    Preset("r150_manage", "Round3 champion control.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
    }),
    Preset("r150_sideways35_manage", "Champion plus more permissive sideways regime.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1_SIDEWAYS_ADX_THRESHOLD_OVERRIDE": "35.0",
    }),
    Preset("r150_allsell_manage", "Champion plus all sell hours.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "V7_ALLOW_ALL_SELL_HOURS": "true",
    }),
    Preset("r150_sideways35_allsell_manage", "Champion plus sideways35 and all sell hours.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1_SIDEWAYS_ADX_THRESHOLD_OVERRIDE": "35.0",
    ...
    Preset("r180_manage", "Slightly harder risk.", {
        **BASE,
        "V7_TrendRiskPercent": "1.80",
        "V7_SidewaysRiskPercent": "0.60",
    }),
    Preset("r180_sideways35_manage", "Harder risk plus sideways35.", {
        **BASE,
        "V7_TrendRiskPercent": "1.80",
        "V7_SidewaysRiskPercent": "0.60",
        "IF1_SIDEWAYS_ADX_THRESHOLD_OVERRIDE": "35.0",
    }),
    Preset("r180_allsell_manage", "Harder risk plus all sell hours.", {
        **BASE,
        "V7_TrendRiskPercent": "1.80",
        "V7_SidewaysRiskPercent": "0.60",
        "V7_ALLOW_ALL_SELL_HOURS": "true",
    }),
    Preset("r200_manage", "Push risk harder.", {
        **BASE,
        "V7_TrendRiskPercent": "2.00",
        "V7_SidewaysRiskPercent": "0.70",
    }),
    Preset("r150_sideways35_sell80_manage", "Champion plus sideways35 and looser sell score.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1_SIDEWAYS_ADX_THRESHOLD_OVERRIDE": "35.0",
    ...
    Preset("r150_sideways35_buy68_manage", "Champion plus slightly looser buy score.", {
        **BASE,
        "V7_TrendRiskPercent": "1.50",
        "V7_SidewaysRiskPercent": "0.50",
        "IF1_SIDEWAYS_ADX_THRESHOLD_OVERRIDE": "35.0",
        "IF1_SCORE_BUY_MIN_OVERRIDE": "68",
    }),
]
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v7", source_path, f"round4_{preset.name}")
