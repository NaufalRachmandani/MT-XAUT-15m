...
RUN_DIR = ROOT / "build" / "v7_round5_sell_struct"
...
PRESETS = [
    Preset("control", "Current v7 champion control.", dict(BASE)),
    Preset("sell_struct_a", "All sell hours, low-score sell hour mask, low-score sell RR cap.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "V7_USE_LOW_SCORE_SELL_BLOCK_MASK": "true",
        "V7_TREND_LOW_SCORE_SELL_RR_OVERRIDE": "1.35",
        "V7_TREND_LOW_SCORE_SELL_LOT_MULT": "0.35",
    }),
    Preset("sell_struct_b", "A plus looser sell min score.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "V7_USE_LOW_SCORE_SELL_BLOCK_MASK": "true",
        "V7_TREND_LOW_SCORE_SELL_RR_OVERRIDE": "1.35",
    ...
    Preset("sell_struct_c", "A plus high-score sell structural gate.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "V7_USE_LOW_SCORE_SELL_BLOCK_MASK": "true",
        "V7_TREND_LOW_SCORE_SELL_RR_OVERRIDE": "1.35",
        "V7_TREND_LOW_SCORE_SELL_LOT_MULT": "0.35",
        "V7_GOLD_HIGH_SCORE_SELL_REQUIRE_IMPULSIVE_BOS": "true",
    }),
    Preset("sell_struct_d", "C plus looser sell min score.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "V7_USE_LOW_SCORE_SELL_BLOCK_MASK": "true",
        "V7_TREND_LOW_SCORE_SELL_RR_OVERRIDE": "1.35",
    ...
    Preset("sell_struct_e", "D plus slightly larger sell risk.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "V7_USE_LOW_SCORE_SELL_BLOCK_MASK": "true",
        "V7_TREND_LOW_SCORE_SELL_RR_OVERRIDE": "1.35",
    ...
    Preset("sell_struct_f", "Only high-score sell structure, no all-hours unlock.", {
        **BASE,
        "V7_GOLD_HIGH_SCORE_SELL_REQUIRE_IMPULSIVE_BOS": "true",
    }),
    Preset("sell_off", "Disable sell risk to measure contribution.", {
        **BASE,
        "V7_SellRiskMultiplier": "0.00",
    }),
]
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v7", source_path, f"round5_{preset.name}")
