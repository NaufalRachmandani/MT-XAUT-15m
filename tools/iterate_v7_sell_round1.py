...
PRESETS = [
    ...
    Preset("sell_mult_050", "Lower sell risk multiplier.", {
        **BASE,
        "V7_SellRiskMultiplier": "0.50",
    }),
    Preset("sell_mult_085", "Raise sell risk multiplier modestly.", {
        **BASE,
        "V7_SellRiskMultiplier": "0.85",
    }),
    Preset("sell_mult_100", "Full sell risk parity.", {
        **BASE,
        "V7_SellRiskMultiplier": "1.00",
    }),
    Preset("sell_score_80", "Looser sell score gate.", {
        **BASE,
        "IF1_SCORE_SELL_MIN_OVERRIDE": "80",
    }),
    Preset("sell_score_75", "Much looser sell score gate.", {
        **BASE,
        "IF1_SCORE_SELL_MIN_OVERRIDE": "75",
    }),
    Preset("sell_score_80_mult_085", "Looser score and modestly larger sell risk.", {
        **BASE,
        "IF1_SCORE_SELL_MIN_OVERRIDE": "80",
        "V7_SellRiskMultiplier": "0.85",
    }),
    Preset("all_sell_hours", "Allow all sell hours.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
    }),
    Preset("all_sell_score80", "Allow all sell hours plus looser score.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "IF1_SCORE_SELL_MIN_OVERRIDE": "80",
    }),
    Preset("all_sell_score80_mult085", "Allow all sell hours plus looser score and bigger sell risk.", {
        **BASE,
        "V7_ALLOW_ALL_SELL_HOURS": "true",
        "IF1_SCORE_SELL_MIN_OVERRIDE": "80",
        "V7_SellRiskMultiplier": "0.85",
    }),
    Preset("sell_off", "Effectively disable sell sizing.", {
        **BASE,
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v7", source_path, f"sell1_{preset.name}")
