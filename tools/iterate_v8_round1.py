...
PRESETS = [
    Preset("no_regime", "v7-equivalent control.", {
        "V8_ENABLE_BEARISH_REGIME": "false",
    }),
    Preset("regime_default", "Default bearish regime switch.", {}),
    Preset("regime_soft", "Softer bearish regime buy suppression.", {
        "V8_BEARISH_BUY_MIN_SCORE": "85",
        "V8_BEARISH_BUY_RISK_MULT": "0.50",
        "V8_BEARISH_SELL_RISK_MULT": "1.00",
    }),
    Preset("regime_hard", "Hard bearish mode with stronger buy suppression and sell boost.", {
        "V8_BEARISH_BUY_MIN_SCORE": "101",
        "V8_BEARISH_BUY_RISK_MULT": "0.00",
        "V8_BEARISH_SELL_RISK_MULT": "1.25",
    }),
    Preset("regime_keep_sideways", "Bearish regime but keep sideways layer active.", {
        "V8_DISABLE_SIDEWAYS_IN_BEARISH_REGIME": "false",
    }),
    Preset("regime_adx28", "Bearish regime requires stronger H4 ADX.", {
        "V8_BEARISH_REGIME_ADX_MIN": "28.0",
    }),
    Preset("regime_soft_keep_sideways", "Soft bearish regime while keeping sideways.", {
        "V8_BEARISH_BUY_MIN_SCORE": "85",
        "V8_BEARISH_BUY_RISK_MULT": "0.50",
        "V8_BEARISH_SELL_RISK_MULT": "1.00",
        "V8_DISABLE_SIDEWAYS_IN_BEARISH_REGIME": "false",
    }),
    Preset("regime_hard_sell80", "Hard bearish mode plus slightly looser sell min score.", {
        "V8_BEARISH_BUY_MIN_SCORE": "101",
        "V8_BEARISH_BUY_RISK_MULT": "0.00",
        "V8_BEARISH_SELL_RISK_MULT": "1.25",
        "V8_BEARISH_SELL_MIN_SCORE": "80",
    }),
]
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v8", source_path, f"round1_{preset.name}")
