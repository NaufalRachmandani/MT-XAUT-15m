...
BASE_CLOSE3 = {
    "V8_BEARISH_REGIME_ADX_MIN": "28.0",
    "V8_BEARISH_BUY_MIN_SCORE": "101",
    "V8_BEARISH_BUY_RISK_MULT": "0.00",
    "V8_BEARISH_SELL_RISK_MULT": "1.25",
    "V8_BEARISH_REGIME_CLOSE_LOOKBACK": "3",
}

BASE_RISK015_CLOSE3 = {
    "V8_BEARISH_REGIME_ADX_MIN": "28.0",
    "V8_BEARISH_BUY_MIN_SCORE": "95",
    "V8_BEARISH_BUY_RISK_MULT": "0.15",
    "V8_BEARISH_SELL_RISK_MULT": "1.10",
    "V8_BEARISH_REGIME_CLOSE_LOOKBACK": "3",
}


def merged(base: dict[str, str], extra: dict[str, str]) -> dict[str, str]:
    merged_map = dict(base)
    merged_map.update(extra)
    return merged_map


PRESETS = [
    Preset("close3_control", "Round 2 champion reference.", dict(BASE_CLOSE3)),
    Preset("close3_trend195", "Slight trend risk uplift on close3 champion.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "1.95",
    })),
    Preset("close3_trend210", "Moderate trend risk uplift on close3 champion.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "2.10",
    })),
    Preset("close3_trend225", "Aggressive trend risk uplift on close3 champion.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "2.25",
    })),
    Preset("close3_trend195_side065", "Lift both trend and sideways risk slightly.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "1.95",
        "V7_SidewaysRiskPercent": "0.65",
    })),
    Preset("close3_trend210_side065", "Moderate trend risk plus modest sideways risk uplift.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "2.10",
        "V7_SidewaysRiskPercent": "0.65",
    })),
    Preset("close3_trend210_side070", "Moderate trend risk plus stronger sideways risk uplift.", merged(BASE_CLOSE3, {
        "V7_TrendRiskPercent": "2.10",
        "V7_SidewaysRiskPercent": "0.70",
    })),
    Preset("risk015_close3", "Keep tiny buy participation in bearish regime plus faster regime detection.", dict(BASE_RISK015_CLOSE3)),
    Preset("risk015_close3_trend195", "Tiny bearish buy participation plus slight trend risk uplift.", merged(BASE_RISK015_CLOSE3, {
        "V7_TrendRiskPercent": "1.95",
    })),
    Preset("risk015_close3_trend210", "Tiny bearish buy participation plus moderate trend risk uplift.", merged(BASE_RISK015_CLOSE3, {
        "V7_TrendRiskPercent": "2.10",
    })),
]
...
def main() -> None:
    ...
    for preset in PRESETS:
        ...
        stem = compile_variant("v8", source_path, f"round3_{preset.name}")
